...
from ibm_watson_machine_learning.tests.utils import (get_cos_credentials, bucket_exists, create_bucket)
...
class TestDataConnection(unittest.TestCase):
    ...
    def test_07_download_data_asset_zip_from_COS_read_to_file(self):
        ...
        connection.read(use_flight=True, raw=True, flight_parameters=flight_parameters, binary=True,
                        read_to_file=zip_file_path)
