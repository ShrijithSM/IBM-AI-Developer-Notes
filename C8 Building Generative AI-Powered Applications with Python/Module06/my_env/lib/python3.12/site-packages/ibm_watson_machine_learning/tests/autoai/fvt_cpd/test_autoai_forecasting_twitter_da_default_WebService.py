...
class TestAutoAIRemote(AbstractTestTSAsync, unittest.TestCase):
    ...
    def test_09b_get_pipeline_optimizer_from_experiment_metdata(self):
        ...
        training_result_reference = DataConnection(
            location=FSLocation(
                path=f"/spaces/e4da5ecd-1a6a-4a1d-b873-048463759455/assets/auto_ml/auto_ml.{self.run_id}/wml_data/{self.run_id}/data/automl"
            )
        )
    ...
    def test_09c_get_pipeline_optimizer_from_experiment_metdata(self):
        from ibm_watson_machine_learning.helpers import ContainerLocation, FSLocation
