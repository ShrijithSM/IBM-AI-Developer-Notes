...
class TestScikitLearnDeployment(AbstractOnlineDeploymentTest, unittest.TestCase):
    ...
    model_name = deployment_name = "sklearn_model_from_object"
    IS_MODEL = True
    ...
    def test_01a_score_model_object(self):
        predictions = TestScikitLearnDeployment.model.predict(self.create_scoring_payload()['input_data'][0]['values'])
        print(predictions)
