...
from ibm_watson_machine_learning.metanames import FunctionMetaNames, FunctionNewMetaNames, _check_spec_uids
...
class Functions(WMLResource):
    ...
    def get_revision_details(self, function_uid, rev_uid):
        ...
        **Example**
        ...
        self._client._check_if_either_is_set()
        Functions._validate_type(function_uid, u'function_uid', str, True)
        if not Functions._validate_type(rev_uid, u'rev_uid', [str, int], True):
